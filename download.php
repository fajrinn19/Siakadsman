...
if(file_exists($direktori.$filename)){
    ...
    if ($file_extension=='php'){
      ...
      // Update hit counter menggunakan mysqli (jika tabel download ada)
      // Jika tabel download tidak ada, komentar atau hapus baris ini
      if (function_exists('mysqli_query') && isset($koneksi)) {
          // Cek apakah tabel download ada
          $cek_tabel = mysqli_query($koneksi, "SHOW TABLES LIKE 'download'");
