            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-warning btn-sm">Data Golongan </a>
...
<?php 
    ...
    if (isset($_POST[update])){
        mysql_query("UPDATE rb_golongan SET id_golongan = '$_POST[a]',
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=golongan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO rb_golongan VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=golongan';</script>";
    }
