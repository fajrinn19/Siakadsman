            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-warning btn-sm">Data Administrator</a>
...
<?php 
    ...
    if (isset($_POST[update])){
      ...
      if (trim($_POST[b])==''){
        mysql_query("UPDATE rb_users SET username = '$_POST[a]',
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=admin'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
    ...
    if (isset($_POST[tambah])){
      $data = md5($_POST[b]);
      $passs=hash("sha512",$data);
      mysql_query("INSERT INTO rb_users VALUES('','$_POST[a]','$passs','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','superuser','Y')");
      echo "<script>document.location='index.php?view=admin';</script>";
    }
