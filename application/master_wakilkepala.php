            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-primary btn-sm">Data Kepala Sekolah</a>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=wakilkepala'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
