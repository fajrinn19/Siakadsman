            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-warning btn-sm">Data Jurusan</a>
...
<?php 
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO rb_jurusan VALUES('$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_POST[i]','$_POST[j]')");
        echo "<script>document.location='index.php?view=jurusan';</script>";
    }
