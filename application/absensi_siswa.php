  ...
  if ($_GET[gettgl]){
    ...
    echo "<div class='col-md-12'>
              ...
              <input type='hidden' name='jdwl' value='$_GET[jdwl]'>
                <div class='col-md-12'>
                  <table class='table table-condensed table-bordered table-striped' id='table-absensi'>
                      <thead>
                      <tr>
                        <th>No</th>
                        <th>NIPD</th>
                    ...
                    // Tentukan warna baris berdasarkan status absensi
                    $row_color = '';
                    if (empty($a['kode_kehadiran']) || $a['kode_kehadiran'] == '') {
                        $row_color = '#ffcccc'; // MERAH - Belum diisi
                    } else {
                        $row_color = '#ccffcc'; // HIJAU - Sudah diisi
                    }
                    
                    echo "<tr style='background-color: $row_color;' id='row_$no'>
                            <td>$no</td>
                            <td>$r[nipd]</td>
                            <td>$r[nisn]</td>
                            <td>$r[nama]</td>
                            ...
                            <td><select style='width:100px;' name='a[$no]' class='form-control status-select' data-row='$no' onchange='updateRowColor(this)'>";
                ...
                <table class='table table-bordered table-striped'>
                    ...
                    echo "<tr>
                            ...
                            <td style='width:70px !important'><center>
                                <a class='btn btn-success btn-xs' title='Tampil List Absensi' href='index.php?view=absensiswa&act=tampilabsen&id=$r[kodekelas]&kd=$r[kodepelajaran]&jdwl=$r[kodejdwl]'><span class='glyphicon glyphicon-th'></span> Tampilkan Absensi</a>
                              </center></td>
                            </tr>";
                      $no++;
                      }
...
<!-- Tambahkan JavaScript untuk update warna otomatis -->
<script>
function updateRowColor(selectElement) {
    ...
    if (selectElement.value === '' || selectElement.value === null) {
        row.style.backgroundColor = '#ffcccc'; // MERAH - Belum diisi
    } else {
        row.style.backgroundColor = '#ccffcc'; // HIJAU - Sudah diisi
    }
}

// Untuk memastikan semua baris memiliki warna yang benar saat load
