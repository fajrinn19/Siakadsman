            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box" style= "border-radius: 10px">
                <span class="info-box-icon bg-aqua" style= "border-radius: 10px"><i class="fa fa-users"></i></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box" style= "border-radius: 10px">
                <span class="info-box-icon bg-purple" style= "border-radius: 10px"><i class="fa fa-user"></i></span>
                <div class="info-box-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box" style= "border-radius: 10px">
                <span class="info-box-icon bg-orange" style= "border-radius: 10px"><i class="fa fa-files-o"></i></span>
                <div class="info-box-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box" style= "border-radius: 10px">
                <span class="info-box-icon bg-red" style= "border-radius: 10px"><i class="fa fa-star-o"></i></span>
                <div class="info-box-content">
