<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- Menu Bahan dan Tugas (untuk siswa) -->
            <li><a href="index.php?view=bahantugas&act=listbahantugassiswa"><i class="fa fa-download"></i> <span>Bahan & Tugas</span></a></li>
            
            <!-- Menu Quiz / Ujian Online (untuk siswa) -->
            <li><a href="index.php?view=soal&act=detailsiswa"><i class="fa fa-pencil-square-o"></i> <span>Quiz / Ujian Online</span></a></li>
