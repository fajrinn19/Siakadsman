      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          elseif ($_GET[view]=='absensiswa'){
            ...
            echo "</div>";
          }elseif ($_GET[view]=='rekapabsensiguru'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/absensi_siswa_rekap_guru.php";
            echo "</div>";
          ...
          elseif ($_GET[view]=='raport'){
            ...
            // Izinkan admin, superuser, guru, dan kepala sekolah
            if($_SESSION[level]=='superuser' || $_SESSION[level]=='admin' || $_SESSION[level]=='guru' || $_SESSION[level]=='kepala'){
                echo "<div class='row'>";
                        include "application/raport_cetak.php";
                echo "</div>";
            }else{
                echo "<script>alert('Akses ditolak! Hanya untuk Admin, Guru, dan Kepala Sekolah.'); window.location='index.php';</script>";
            }
