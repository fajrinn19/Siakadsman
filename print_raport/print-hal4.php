...
?>
<head>
<title>Hal 4 - RAPORT SISWA SMA NEGERI 14 SINJAI</title>
...
<table border=0 width=100%>
  <tr>
    ...
    <td width="520"align="center">Mengetahui <br> Kepala SMA Negeri Terbuka</td>
    <td width="260" align="left">Sinjai, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Wali Kelas</td>
  </tr>
  <tr>
